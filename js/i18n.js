...
(function (global) {
  ...
  const I18N = {
    ru: {
      ...
      'paths.lead': 'По бэкапам ходов восстановлен порядок открытия технологий и институтов. Нет бэкапов: games 4–11 и 14.',
      'paths.statsTitle': 'Что открывали первым',
      'paths.firstBranch': 'Первый институт (ветка)',
      'paths.firstTech': 'Первый тех после Agriculture',
      ...
      'paths.era.Ancient_era': 'Древность',
      'paths.era.Classical_era': 'Классика',
      'paths.era.Medieval_era': 'Средневековье',
      'paths.era.Renaissance_era': 'Ренессанс',
      'paths.era.Industrial_era': 'Индустриальная',
      'paths.era.Modern_era': 'Новейшая',
      'paths.era.Atomic_era': 'Атомная',
      'paths.era.Information_era': 'Информационная',
    ...
    en: {
      ...
      'paths.lead': 'Unlock order reconstructed from turn backups. Missing archives: games 4–11 and 14.',
      'paths.statsTitle': 'Most common first unlocks',
      'paths.firstBranch': 'First policy branch',
      'paths.firstTech': 'First tech after Agriculture',
      ...
      'paths.era.Ancient_era': 'Ancient',
      'paths.era.Classical_era': 'Classical',
      'paths.era.Medieval_era': 'Medieval',
      'paths.era.Renaissance_era': 'Renaissance',
      'paths.era.Industrial_era': 'Industrial',
      'paths.era.Modern_era': 'Modern',
      'paths.era.Atomic_era': 'Atomic',
      'paths.era.Information_era': 'Information',
